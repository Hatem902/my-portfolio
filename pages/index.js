      ...
      <Container>
        ...
        <Section delay={0.2}>
          ...
          <Text color={'blue.400'} fontWeight="semibold">
            Dassault Systèmes - 3DEXCITE R&D (Vélizy-Villacoublay) ·<br />
          ...
          <Description
            ...
            hiddenContent={[
              '1. Web development of a comprehensive dashboard featuring actionable statistics and visualizations (error diagnostics, advanced tables, dynamic charts), serving as an execution report for the generation of a 3D media via the Creative Experience application.',
